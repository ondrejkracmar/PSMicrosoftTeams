...
### Browser (Default)
```
Connect-PSMicrosoftTeams -ClientID <String> -TenantID <String> [-Scopes <String[]>] [-Browser]
...
### KeyVault
```
Connect-PSMicrosoftTeams -ClientID <String> -TenantID <String> -VaultName <String> -SecretName <String>
...
### UsernamePassword
```
Connect-PSMicrosoftTeams -ClientID <String> -TenantID <String> -Credential <PSCredential> [-Service <String[]>]
...
### AppSecret
```
Connect-PSMicrosoftTeams -ClientID <String> -TenantID <String> -ClientSecret <SecureString>
 [-Service <String[]>] [-ServiceUrl <String>] [-Resource <String>] [-MakeDefault] [-PassThru]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
### AppCertificate
```
Connect-PSMicrosoftTeams -ClientID <String> -TenantID <String> [-Certificate <X509Certificate2>]
...
### DeviceCode
```
Connect-PSMicrosoftTeams -ClientID <String> -TenantID <String> [-Scopes <String[]>] [-DeviceCode]
 [-Service <String[]>] [-ServiceUrl <String>] [-Resource <String>] [-MakeDefault] [-PassThru]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
### Identity
```
Connect-PSMicrosoftTeams [-Identity] [-IdentityID <String>] [-IdentityType <String>] [-Service <String[]>]
 [-ServiceUrl <String>] [-Resource <String>] [-MakeDefault] [-PassThru] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
### EXAMPLE 1
```
Connect-PSMicrosoftTeams -ClientID $clientID -TenantID $tenantID
```
...
### EXAMPLE 3
```
Connect-PSMicrosoftTeams -ClientID $clientID -TenantID $tenantID -CertificatePath C:\secrets\certs\mde.pfx -CertificatePassword (Read-Host -AsSecureString)
```
...
### EXAMPLE 4
```
Connect-PSMicrosoftTeams -Service Endpoint -ClientID $clientID -TenantID $tenantID -ClientSecret $secret
```
...
### EXAMPLE 5
```
Connect-PSMicrosoftTeams -ClientID $clientID -TenantID $tenantID -VaultName myVault -Secretname GraphCert
```
