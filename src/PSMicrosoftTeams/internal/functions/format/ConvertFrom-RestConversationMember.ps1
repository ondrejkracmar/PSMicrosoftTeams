function ConvertFrom-RestConversationMember {
	<#
	.SYNOPSIS
	...
	.EXAMPLE
		PS C:\> Invoke-RestRequest -Service 'graph' -Path users -Query $query -Method Get -ErrorAction Stop | ConvertFrom-RestConversationMember
