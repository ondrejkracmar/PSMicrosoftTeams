...
Set-PSFConfig -Module 'PSMicrosoftTeams' -Name 'Settings.PostConrtentType' -Value string -Initialize -Validation 'application/json' -Description "Specifies post content type of rest method."
Set-PSFConfig -Module 'PSMicrosoftTeams' -Name 'Settings.AuthorizationToken' -Value string -Initialize -Validation '' -Description "Specifies the last authorization roken of GRAPH APU to Office 65 Teams."