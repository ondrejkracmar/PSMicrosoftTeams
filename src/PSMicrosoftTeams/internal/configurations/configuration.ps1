...
Set-PSFConfig -Module 'PSMicrosoftTeams' -Name 'Settings.GraphApiUrl' -Value "https://graph.microsoft.com" -Initialize -Validation 'uriabsolute' -Description "What url of Graph API module is useing."
Set-PSFConfig -Module 'PSMicrosoftTeams' -Name 'Settings.AuthUrl' -Value "https://login.microsoftonline.com" -Initialize -Validation 'uriabsolute' -Description "What url authentication of Graph API module is useing."
