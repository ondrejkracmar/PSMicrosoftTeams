function Connect-PSMicrosoftTeams {
    <#
	.SYNOPSIS
		Connect to the Microsoft Temas object via Microsoft Graph API
	...
	.EXAMPLE
		PS C:\> Connect-PSMicrosoftEntraID -ClientID $clientID -TenantID $tenantID -TenantName contoso -DeviceCode
