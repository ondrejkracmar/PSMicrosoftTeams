function Get-PSMTGroup
{
	...
	process
	{
        ...
        Try
        {
			...
			Stop-PSFFunction -String 'FailedGetGroup' -StringValues $graphApiParameters['Uri'] -Target $graphApiParameters['Uri'] -SilentlyContinue -ErrorRecord $_ -Tag GraphApi,Get
		}
